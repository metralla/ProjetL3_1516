...
public class StrategieBarde extends StrategiePersonnage {
	/**
	 ...
	 */
	public StrategieBarde(String ipArene, int port, String ipConsole, 
		...
		try {
			console = new Console(ipArene, port, ipConsole, this, 
					new Guerrier(nom, groupe, caracts), 
